...
# domain random
CDN="https://raw.githubusercontent.com/begugithub/AUTO-SCRIPT/master/ssh"
cd /root
...
sleep 0.5
clear
wget https://raw.githubusercontent.com/begugithub/AUTO-SCRIPT/master/ssh/ssh-vpn.sh && chmod +x ssh-vpn.sh && ./ssh-vpn.sh
#Instal Xray
echo -e "\e[33m-----------------------------------\033[0m"
...
sleep 0.5
clear
wget https://raw.githubusercontent.com/begugithub/AUTO-SCRIPT/master/xray/ins-xray.sh && chmod +x ins-xray.sh && ./ins-xray.sh
wget https://raw.githubusercontent.com/begugithub/AUTO-SCRIPT/master/sshws/insshws.sh && chmod +x insshws.sh && ./insshws.sh
clear
